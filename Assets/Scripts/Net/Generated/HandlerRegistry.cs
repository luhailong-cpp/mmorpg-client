...
namespace MmorpgClient.Net.Generated
{
    public static class HandlerRegistry
    {
        public static void Register(GameClient client)
        {
            ...
            client.OnNotify(ClientPlayerTeamApplyJoinTeamHandler.MessageId, mc => ClientPlayerTeamApplyJoinTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamCreateTeamHandler.MessageId, mc => ClientPlayerTeamCreateTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamDisbandTeamHandler.MessageId, mc => ClientPlayerTeamDisbandTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamGetMyTeamHandler.MessageId, mc => ClientPlayerTeamGetMyTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamHandleApplicationHandler.MessageId, mc => ClientPlayerTeamHandleApplicationHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamInviteToTeamHandler.MessageId, mc => ClientPlayerTeamInviteToTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamKickMemberHandler.MessageId, mc => ClientPlayerTeamKickMemberHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamLeaveTeamHandler.MessageId, mc => ClientPlayerTeamLeaveTeamHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamListMyInvitesHandler.MessageId, mc => ClientPlayerTeamListMyInvitesHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamNotifyTeamEventHandler.MessageId, mc => ClientPlayerTeamNotifyTeamEventHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamNotifyTeamInviteHandler.MessageId, mc => ClientPlayerTeamNotifyTeamInviteHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamNotifyTeamSnapshotHandler.MessageId, mc => ClientPlayerTeamNotifyTeamSnapshotHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamRespondInviteHandler.MessageId, mc => ClientPlayerTeamRespondInviteHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamStartTeamMatchHandler.MessageId, mc => ClientPlayerTeamStartTeamMatchHandler.Dispatch(client, mc));
            client.OnNotify(ClientPlayerTeamTransferLeaderHandler.MessageId, mc => ClientPlayerTeamTransferLeaderHandler.Dispatch(client, mc));
